...
VALUES ('1', 'Alfreds Futterkiste', 'Maria Anders', 'Obere Str. 57', 'Berlin', '12209', 'Germany'),
       ...
       ('39transaction.sql', 'Königlich Essen', 'Philip Cramer', 'Maubelstr. 90', 'Brandenburg', '14776', 'Germany'),
...
VALUES ('1', '10248', '11', '12'),
       ...
       ('131', '10296', '16', '30'),
       ('132', '10296', '69', '15'),
       ('133', '10297', '39transaction.sql', '60'),
       ('134', '10297', '72', '20'),
       ('135', '10298', '2', '40'),
       ('136', '10298', '36', '40'),
       ('137', '10298', '59', '30'),
       ...
       ('154', '10305', '18', '25'),
       ('155', '10305', '29', '25'),
       ('156', '10305', '39transaction.sql', '30'),
       ('157', '10306', '30', '10'),
       ('158', '10306', '53', '10'),
       ('159', '10306', '54', '5'),
       ('160', '10307', '62', '10'),
       ...
       ('265', '10346', '56', '20'),
       ('266', '10347', '25', '10'),
       ('267', '10347', '39transaction.sql', '50'),
       ('268', '10347', '40', '4'),
       ('269', '10347', '75', '6'),
       ('270', '10348', '1', '15'),
       ('271', '10348', '23', '25'),
       ...
       ('302', '10360', '49', '35'),
       ('303', '10360', '54', '28'),
       ('304', '10361', '39transaction.sql', '54'),
       ('305', '10361', '60', '55'),
       ('306', '10362', '25', '50'),
       ('307', '10362', '51', '20'),
       ('308', '10362', '54', '24'),
       ...
       ('341', '10376', '31', '42'),
       ('342', '10377', '28', '20'),
       ('343', '10377', '39transaction.sql', '20'),
       ('344', '10378', '71', '6'),
       ('345', '10379', '41', '8'),
       ('346', '10379', '63', '16'),
       ('347', '10379', '65', '20'),
       ...
       ('548', '10454', '33', '20'),
       ('549', '10454', '46', '10'),
       ('550', '10455', '39transaction.sql', '20'),
       ('551', '10455', '53', '50'),
       ('552', '10455', '61', '25'),
       ('553', '10455', '71', '30'),
       ('554', '10456', '21', '40'),
       ...
       ('610', '10477', '1', '15'),
       ('611', '10477', '21', '21'),
       ('612', '10477', '39transaction.sql', '20'),
       ('613', '10478', '10', '20'),
       ('614', '10479', '38', '30'),
       ('615', '10479', '53', '28'),
       ('616', '10479', '59', '60'),
       ...
       ('681', '10507', '48', '15'),
       ('682', '10508', '13', '10'),
       ('683', '10508', '39transaction.sql', '10'),
       ('684', '10509', '28', '3'),
       ('685', '10510', '29', '36'),
       ('686', '10510', '75', '36'),
       ('687', '10511', '4', '50'),
       ...
       ('695', '10513', '32', '50'),
       ('696', '10513', '61', '15'),
       ('697', '10514', '20', '39transaction.sql'),
       ('698', '10514', '28', '35'),
       ('699', '10514', '56', '70'),
       ('700', '10514', '65', '39transaction.sql'),
       ('701', '10514', '75', '50'),
       ('702', '10515', '9', '16'),
       ('703', '10515', '16', '50'),
       ('704', '10515', '27', '120'),
       ...
       ('881', '10576', '31', '20'),
       ('882', '10576', '44', '21'),
       ('883', '10577', '39transaction.sql', '10'),
       ('884', '10577', '75', '20'),
       ('885', '10577', '77', '18'),
       ('886', '10578', '35', '20'),
       ('887', '10578', '57', '6'),
       ...
       ('1039', '10642', '61', '20'),
       ('1040', '10643', '28', '15'),
       ('1041', '10643', '39transaction.sql', '21'),
       ('1042', '10643', '46', '2'),
       ('1043', '10644', '18', '4'),
       ('1044', '10644', '43', '20'),
       ('1045', '10644', '46', '21'),
       ...
       ('1051', '10646', '77', '35'),
       ('1052', '10647', '19', '30'),
       ('1053', '10647', '39transaction.sql', '20'),
       ('1054', '10648', '22', '15'),
       ('1055', '10648', '24', '15'),
       ('1056', '10649', '28', '20'),
       ('1057', '10649', '72', '15'),
       ...
       ('1066', '10653', '60', '20'),
       ('1067', '10654', '4', '12'),
       ('1068', '10654', '39transaction.sql', '20'),
       ('1069', '10654', '54', '6'),
       ('1070', '10655', '41', '20'),
       ('1071', '10656', '14', '3'),
       ('1072', '10656', '44', '28'),
       ...
       ('1086', '10659', '70', '40'),
       ('1087', '10660', '20', '21'),
       ('1088', '10661', '39transaction.sql', '3'),
       ('1089', '10661', '58', '49'),
       ('1090', '10662', '68', '10'),
       ('1091', '10663', '40', '30'),
       ('1092', '10663', '42', '30'),
       ...
       ('1354', '10761', '25', '35'),
       ('1355', '10761', '75', '18'),
       ('1356', '10762', '39transaction.sql', '16'),
       ('1357', '10762', '47', '30'),
       ('1358', '10762', '51', '28'),
       ('1359', '10762', '56', '60'),
       ('1360', '10763', '21', '40'),
       ...
       ('1362', '10763', '24', '20'),
       ('1363', '10764', '3', '20'),
       ('1364', '10764', '39transaction.sql', '130'),
       ('1365', '10765', '65', '80'),
       ('1366', '10766', '2', '40'),
       ('1367', '10766', '7', '35'),
       ('1368', '10766', '68', '40'),
       ...
       ('1404', '10783', '38', '5'),
       ('1405', '10784', '36', '30'),
       ('1406', '10784', '39transaction.sql', '2'),
       ('1407', '10784', '72', '30'),
       ('1408', '10785', '10', '10'),
       ('1409', '10785', '75', '10'),
       ('1410', '10786', '8', '30'),
       ...
       ('1508', '10826', '57', '15'),
       ('1509', '10827', '10', '15'),
       ('1510', '10827', '39transaction.sql', '21'),
       ('1511', '10828', '20', '5'),
       ('1512', '10828', '38', '2'),
       ('1513', '10829', '2', '10'),
       ('1514', '10829', '8', '20'),
       ...
       ('1516', '10829', '60', '21'),
       ('1517', '10830', '6', '6'),
       ('1518', '10830', '39transaction.sql', '28'),
       ('1519', '10830', '60', '30'),
       ('1520', '10830', '68', '24'),
       ('1521', '10831', '19', '2'),
       ('1522', '10831', '35', '8'),
       ...
       ('1549', '10839', '72', '15'),
       ('1550', '10840', '25', '6'),
       ('1551', '10840', '39transaction.sql', '10'),
       ('1552', '10841', '10', '16'),
       ('1553', '10841', '56', '30'),
       ('1554', '10841', '59', '50'),
       ('1555', '10841', '77', '15'),
       ...
       ('1620', '10864', '67', '15'),
       ('1621', '10865', '38', '60'),
       ('1622', '10865', '39transaction.sql', '80'),
       ('1623', '10866', '2', '21'),
       ('1624', '10866', '24', '6'),
       ('1625', '10866', '30', '40'),
       ('1626', '10867', '53', '3'),
       ...
       ('1692', '10894', '75', '120'),
       ('1693', '10895', '24', '110'),
       ('1694', '10895', '39transaction.sql', '45'),
       ('1695', '10895', '40', '91'),
       ('1696', '10895', '60', '100'),
       ('1697', '10896', '45', '15'),
       ('1698', '10896', '56', '16'),
       ...
       ('1700', '10897', '30', '36'),
       ('1701', '10898', '13', '5'),
       ('1702', '10899', '39transaction.sql', '8'),
       ('1703', '10900', '70', '3'),
       ('1704', '10901', '41', '30'),
       ('1705', '10901', '71', '30'),
       ('1706', '10902', '55', '30'),
       ...
       ('1877', '10975', '75', '10'),
       ('1878', '10976', '28', '20'),
       ('1879', '10977', '39transaction.sql', '30'),
       ('1880', '10977', '47', '30'),
       ('1881', '10977', '51', '10'),
       ('1882', '10977', '63', '20'),
       ('1883', '10978', '8', '20'),
       ...
       ('2109', '11068', '43', '36'),
       ('2110', '11068', '77', '28'),
       ('2111', '11069', '39transaction.sql', '20'),
       ('2112', '11070', '1', '40'),
       ('2113', '11070', '2', '20'),
       ('2114', '11070', '16', '30'),
       ('2115', '11070', '31', '20'),
       ...
       ('2143', '11077', '23', '2'),
       ('2144', '11077', '32', '1'),
       ('2145', '11077', '39transaction.sql', '2'),
       ('2146', '11077', '41', '3'),
       ('2147', '11077', '46', '3'),
       ('2148', '11077', '52', '2'),
       ('2149', '11077', '55', '2'),
...
VALUES ('10248', '90', '5', '1996-07-04', '3'),
       ...
       ('10323', '39transaction.sql', '4', '1996-10-07', '1'),
       ('10324', '71', '9', '1996-10-08', '1'),
       ('10325', '39transaction.sql', '1', '1996-10-09', '3'),
       ...
       ('10456', '39transaction.sql', '8', '1997-02-25', '2'),
       ('10457', '39transaction.sql', '2', '1997-02-25', '1'),
       ...
       ('10468', '39transaction.sql', '3', '1997-03-07', '3'),
       ...
       ('10506', '39transaction.sql', '9', '1997-04-15', '2'),
       ...
       ('10542', '39transaction.sql', '1', '1997-05-20', '3'),
       ...
       ('10630', '39transaction.sql', '1', '1997-08-13', '2'),
       ...
       ('10718', '39transaction.sql', '1', '1997-10-27', '3'),
       ...
       ('10799', '39transaction.sql', '9', '1997-12-26', '3'),
       ...
       ('10817', '39transaction.sql', '3', '1998-01-06', '2'),
       ...
       ('10849', '39transaction.sql', '9', '1998-01-23', '2'),
       ...
       ('10893', '39transaction.sql', '9', '1998-02-18', '2'),
       ...
       ('11028', '39transaction.sql', '2', '1998-04-16', '1'),
...
VALUES ('1', 'Chais', '1', '1', '10 boxes x 20 bags', '18'),
       ...
       ('17', 'Alice Mutton', '7', '6', '20 - 1 kg tins', '39transaction.sql'),
       ...
       ('39transaction.sql', 'Chartreuse verte', '18', '1', '750 cc per bottle', '18'),
