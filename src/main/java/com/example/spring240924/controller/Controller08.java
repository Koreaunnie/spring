...
public class Controller08 {
    ...
    // /WEB-INF/view/main8/sub2.jsp 로 포워드 후
    ...
    public void sub2(Model model){
        ...
        // attribute 는 아무 거나 넣을 수 있음 (Object 타입이라서)
    ...
    public void sub4(Model model){
        model.addAttribute("countries", new String[] {"korea", "us", "uk"});
    ...
    public void sub5(Model model){
        model.addAttribute("names", new String[] {"홍명보", "손흥민"});
    ...
    public void sub6(Model model){
        // attribute 에 List 넣기
        model.addAttribute("names", List.of("명보", "흥민", "강인"));
    }
    ...
    public void sub8(Model model){
        model.addAttribute( "students", List.of("아라", "비안", "나이트"));
