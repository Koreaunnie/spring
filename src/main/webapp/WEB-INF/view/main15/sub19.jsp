...
<c:if test="true" var="someTest"> <%-- page 영역에 들어가있음 --%>
</c:if>

<c:if test="${someTest}"> <%-- page 영역에 들어가있음 --%>
</c:if>

<c:import url="sub19.jsp" var="sub19output"/> <%-- page 영역에 들어가있음 --%>
<p>${sub19output}</p>
